...
new pcv_color, pcv_by_radius, pcv_hitself, pcv_los, pcv_maxdamage, pcv_mindamage, pcv_chill_maxchance,
		pcv_chill_duration, pcv_chill_variance, pcv_chill_speed, pcv_freeze_maxchance, pcv_freeze_minchance,
		pcv_freeze_duration, pcv_freeze_variance, pcv_chill_minchance;
/*pcv_enabled, pcv_override pcv_nadetypes, pcv_teams, pcv_price, pcv_icon, pcv_limit, pcv_buyzone*/

new maxPlayers, gmsgScreenFade, gmsgStatusIcon, glassGibs, trailSpr, smokeSpr, exploSpr, mp_friendlyfire, 
		czero, bot_quota, czBotHams, fmFwdPPT, fnFwdPlayerChilled, fnFwdPlayerFrozen, bool:roundRestarting;
/*gmsgAmmoPickup, gmsgBlinkAcct, gmsgTextMsg, gmsgWeapPickup*/
...
public plugin_init()
{
	register_plugin("Furien : FrostNades", VERSION, "Shooting King & Avalanche");
...
player_has_frostnade(id)
{
		...
		if(cs_get_user_bpammo(id, NT_SMOKEGRENADE) > 0)
		{
